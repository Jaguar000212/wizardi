    ...
    async def callback(self, interaction: disnake.Interaction):
        ...
        if view.current_player == view.X:
            ...
            if interaction.user == view.player1:
                ...
                self.emoji = "<:z_BOT_error:946056945935192114>"
                self.disabled = True
                view.board[self.y][self.x] = view.X
                view.current_player = view.O
                embed.description = f"`Challenger` - {view.player2.mention} (<:z_BOT_online:945976489420128256>)\n`Opponent` - {view.player1.mention} (<:z_BOT_error:946056945935192114>)\n\n```diff\n- Current Turn - {view.player2}```"
            ...
            if interaction.user == view.player2:
                ...
                self.emoji = "<:z_BOT_online:945976489420128256>"
                self.disabled = True
